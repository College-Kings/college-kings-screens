...
screen main_menu():
    ...
    imagebutton:
        idle "main_menu_ep_idle"
        action OpenURL("https://store.steampowered.com/app/3126690/College_Kings_2__Episode_6_Summer_Showdown/")
        pos (35, 35)
    ...
    text "v{} (ep{})".format(config.version, get_highest_ep() if is_CK2 else "14") align (1.0, 1.0) xoffset -20 color "#4e628f" size 30
